...
This is the v2 module (`github.com/paluszkiewiczB/gig/v2`). It is not backward
compatible with v1 (`github.com/paluszkiewiczB/gig`).
...
- [`WithEnvOptions`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#WithEnvOptions)
- [`WithFileOptions`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#WithFileOptions)
- [`WithMutators`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#WithMutators)
- [`WithSources`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#WithSources)
- [`WithValidation`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#WithValidation)

## Reference

- [`Mutator`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#Mutator)
- [`NewTagResolver`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#NewTagResolver)
- [`NewEnvHandler`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#NewEnvHandler)
- [`NewFileHandler`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#NewFileHandler)
- [`NewOverride`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#NewOverride)
- [`YamlKey`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#YamlKey)
- [`ResolveError`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#ResolveError)
- [`Validator`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#Validator)
- [`ValidatorContext`](https://pkg.go.dev/github.com/paluszkiewiczB/gig/v2#ValidatorContext)

## Install

```sh
go get github.com/paluszkiewiczB/gig/v2
```
